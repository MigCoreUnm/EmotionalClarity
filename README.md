...
- **Hands-Free Voice Assistant:** Say "listen" to dictate the last utterance into the text box or "let me think about this" to capture a new frame.
...
- Say "listen" to start/stop dictation. When active, the last spoken line fills the conversation field automatically.
- Say "let me think about this" to trigger the Streamlit camera button without touching the screen.
